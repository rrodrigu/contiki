...
/*#define SETSCK1 PORTD|=(1<<PD0)
#define SETSCK0 PORTD&=~(1<<PD0)
#define SCKOUTP DDRD|=(1<<PD0)
*/
...
/*static uint8_t gSensor2dataDDR[4] = {PD0,PD1,PD4,PD5};
static uint8_t gSensor2dataPORT[4] = {PD0,PD1,PD4,PD5};
static uint8_t gSensor2dataPIN[4] = {PD0,PD1,PD4,PD5};
*/
